...
def basic_headers(req, mdn):
	...
	req.add_header("App-Agent", "Etc;Etc;%s;birzzle;1.0;SHW-M130L;WiFi" % mdn)
	req.add_header("App-Agent", "Android;Android OS2.1.2;%s;wagle;3.0;SHW-M130L;WiFi" % mdn)
	req.add_header("App-Agent", "Etc;Etc;%s;zombie;1.0;SHW-M130L;WiFi" % mdn)
	req.add_header("AKey", "ulTBkny8A/ji1rwfKRTIPalP2pk=#NA==")
	req.add_header("AKey", "K3GKudu0Xk83V0TsP0UYqAzsGCY=#NQ==")
	req.add_header("AKey", "KZLv9SqivAwAyDR7R6HPn36STIs=#MA==") # wagl
