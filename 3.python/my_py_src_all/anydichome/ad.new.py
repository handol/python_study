...
def do_naver_and_pidic(orgword, urlword):
	#-------------
	try:
		pidic(orgword)
	except:
...
if __name__=='__main__':
	...
	#keywords = "인터넷 영영 사전 애니딕: " + keywords
	keywords = "인터넷 영영 사전 애니딕 "
	...
	print """<a href="#eedict"> 영영사전 바로가기 </a>"""
	...
	print GOOGLE
	print "</br>"
	do_naver_and_pidic(orgword, urlword)
	print "</br>"
	print """</td></tr></table>"""
