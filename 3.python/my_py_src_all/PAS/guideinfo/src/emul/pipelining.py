...
def printHttpMesg(mesg):
	pos = mesg.find("\r\n\r\n")
	if pos == -1:
		pos = mesg.find("\n\n")
	if pos != -1 and mesg.startswith("HTTP"):
		print mesg[:pos]
####
...
if __name__ == "__main__":
	...
	msg1 = REQMSG % ("http://localhost:9000/timeout_10.html", "localhost", MDN, MDN)	
	msg2 = REQMSG % ("http://localhost:9000/timeout_1.html", "localhost", MDN, MDN)	
	msg1 = REQMSG % ("http://localhost/cgi-bin/sleep35.cgi", "localhost", MDN, MDN)	
	msg2 = REQMSG % ("http://localhost/cgi-bin/sleep1.cgi", "localhost", MDN, MDN)	
	msg1 = REQMSG % ("http://anydic.com/", "anydic.com", MDN, MDN)	
	msg2 = REQMSG % ("http://anydic.com/help.html", "anydic.com", MDN, MDN)	
	#msg2 = REQMSG % ("http://anydic.com/help.html", "anydic.com", MDN, MDN)	

	sock = connPAS(host=HOST, port=PORT)
	sendtoPAS(sock, msg1, msg2)
	sock.close()
