...
def basic_headers(req, mdn):
	...
	req.add_header("App-Agent", "Android;Android OS2.1.2;%s;petloves;1.0;SHW-M130L;WiFi" % mdn)
	#req.add_header("App-Agent", "Etc;Etc;Etc;petloves;1.0;Etc;LAN")	
	req.add_header("AKey", "8R8A+JiT1AMxzSZZw/irpuRZnN0=#Ng==")
...
if __name__ == "__main__":
	...
	#post(host=HOST, atoken=TOKEN, accessType='020', text='hello')

	#moimlist(host=HOST, atoken=TOKEN)
	#moimpost(host=HOST, atoken=TOKEN, gathID='368', wterConts='hi hi') 
